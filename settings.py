# Django settings for timeslot project.
import os
import django
...
DATABASES = {
    'default': {
        ...
        'NAME': 'timeslot',                      # Or path to database file if using sqlite3.
        'USER': 'timeslot',                      # Not used with sqlite3.
        'PASSWORD': 'timeslot',                  # Not used with sqlite3.
...
SECRET_KEY = 'lz&3pbta@$odqvz#!u2f97tzz_(m-2+!rt&auu@z5$lr!149s2'
...
MIDDLEWARE_CLASSES = (
    ...
    'timeslot.middleware.ContentTypeMiddleware',
    'timeslot.disable.DisableCSRF', # temporary
)

ROOT_URLCONF = 'timeslot.urls'
